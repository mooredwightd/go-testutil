...
func checkForJsonFields(t *testing.T, fmap map[int]string) (found bool) {
	...
	for _, v := range flds1 {
		isThere := testutil.AssertTextInFiles(t, fmap, v)
		found = (isThere && found)
	}
	return
}
...
func TestSeverity_String(t *testing.T) {
	...
	t.Run(runName, func(t *testing.T) {
		...
		testutil.AssertEqual(t, severityToString[Emergency], v, GetCaller()+" Expected EMERG")
		v = Severity(Alert).String()
		testutil.AssertEqual(t, severityToString[Alert], v, GetCaller()+" Expected ALERT")
		v = Severity(Critical).String()
		testutil.AssertEqual(t, severityToString[Critical], v, GetCaller()+" Expected CRIT")
		v = Severity(Error).String()
		testutil.AssertEqual(t, severityToString[Error], v, GetCaller()+" Expected ERROR")
		v = Severity(Warning).String()
		testutil.AssertEqual(t, severityToString[Warning], v, GetCaller()+" Expected WARN")
		v = Severity(Notice).String()
		testutil.AssertEqual(t, severityToString[Notice], v, GetCaller()+" Expected NOTIC")
		v = Severity(Info).String()
		testutil.AssertEqual(t, severityToString[Info], v, GetCaller()+" Expected INFO")
		v = Severity(Debug).String()
		testutil.AssertEqual(t, severityToString[Debug], v, GetCaller()+" Expected DEBUG")
	})
	...
	t.Run(runName, func(t *testing.T) {
		v := Severity(0).String()
		testutil.AssertEqual(t, severityToString[0], v, GetCaller()+" Expected panic")
	})
	...
	t.Run(runName, func(t *testing.T) {
		...
		testutil.AssertEqual(t, "", v, GetCaller()+" Expected panic")
	})
...
func TestIsValidSeverity(t *testing.T) {
	...
	t.Run(runName, func(t *testing.T) {
		...
		for _, v := range tStr {
			...
			testutil.AssertTrue(t, ok, runName+" Expected true for "+v)
		}
	})
	...
	t.Run(runName, func(t *testing.T) {
		...
		for _, v := range tStr {
			ok = IsValidSeverity(v)
			testutil.AssertFalse(t, ok, runName+" Expected true for "+v)
		}
	})
...
func TestLogManger(t *testing.T) {
	...
	t.Run(testName+"=1", func(t *testing.T) {
		...
		testutil.AssertNil(t, err, "Error creating new log file w/ NewFile()")
		testutil.AssertNotNil(t, lf, "Expected valid LogFile")
		fn := lf.LogFilename()
		...
		cOk := testutil.AssertTextInFiles(t, map[int]string{1: fn}, tStr)
		testutil.AssertTrue(t, cOk, GetCaller()+" Expected string not found: "+tStr)
		cOk = checkForJsonFields(t, map[int]string{1: fn})
		testutil.AssertTrue(t, cOk, GetCaller()+" Expected JSON tags not found.")
	})
...
func TestLog_AddLogger(t *testing.T) {
	...
	t.Run(runName, func(t *testing.T) {
		...
		lf, err := File(name)
		testutil.AssertNil(t, err, GetCaller()+" Error creating new log file w/ NewFile()")
		testutil.AssertNotNil(t, lf, GetCaller()+" Expected valid LogFile")
		...
		testutil.AssertEqual(t, len(l.logModules), 3, GetCaller()+" Expected 3 loggers")

		cOk := testutil.AssertTextInFiles(t, names, tStr)
		testutil.AssertTrue(t, cOk, GetCaller()+" Expected string not found: "+tStr)
...
func TestLog_Close(t *testing.T) {
	...
	t.Run(testName+"=1", func(t *testing.T) {
		...
		testutil.AssertEqual(t, len(l.logModules), 1, GetCaller()+" Expected 1 logger")
		l.Close()
		testutil.AssertEqual(t, len(l.logModules), 0, GetCaller()+" Expected 0 logger")
	})
	...
	t.Run(testName+"=2", func(t *testing.T) {
		...
		l := LogManger(testName, lf)
		l.Close()
		testutil.AssertEqual(t, len(l.logModules), 0, GetCaller()+" Expected 0 loggers")
	})
}
...
func TestLog_LogEvent(t *testing.T) {
	...
	t.Run(testName+"=1", func(t *testing.T) {
		...
		for k, v := range params {
			cOk = testutil.AssertTextInFiles(t, map[int]string{1: fn}, k)
			testutil.AssertTrue(t, cOk, GetCaller()+" Expected string not found: "+k)
			cOk = testutil.AssertTextInFiles(t, map[int]string{1: fn}, v)
			testutil.AssertTrue(t, cOk, GetCaller()+" Expected string not found: "+v)
		}
...
func testSeverities(t *testing.T, testName string, sev Severity) (success bool) {
	...
	success = testutil.AssertTextInFiles(t, map[int]string{1: fn}, tStr)
	return
}
...
func TestLog_Emergency(t *testing.T) {
	...
	testutil.AssertTrue(t, ok, GetCaller()+" Expected "+stype.String())
}
...
func TestLog_Debug2(t *testing.T) {
	...
	success := testutil.AssertTextInFiles(t, map[int]string{1: fn}, Severity(Alert).String())
	testutil.AssertTrue(t, success, GetCaller()+" Expected to find unfiltered entry.")

	tStr := Severity(Debug).String()
	success = testutil.AssertTextNotInFiles(t, map[int]string{1: fn}, tStr)
}
